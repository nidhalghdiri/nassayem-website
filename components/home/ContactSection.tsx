          ...
          <AnimatedSection delay={0.1} className="space-y-10">
            ...
            <div className="space-y-6">
              <a
                ...
                className="flex items-start gap-4 -m-2 p-2 rounded-xl hover:bg-gray-50 active:bg-gray-100 transition-colors"
              >
                ...
                <div>
                  ...
                  <span className="text-sm font-medium text-nassayem mt-1 inline-block">
            ...
            <div className="pt-6 border-t border-gray-100">
              ...
              <div className="flex gap-4">
                ...
                <a
                  ...
                  aria-label={isEn ? "Chat on WhatsApp" : "تواصل عبر واتساب"}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* Instagram — rendered only once a real profile URL is set */}
                ...
                {/* LinkedIn — rendered only once a real profile URL is set */}
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={isPending}
                  className="w-full bg-nassayem text-white font-bold text-lg py-4 rounded-xl hover:bg-nassayem-dark shadow-md hover:shadow-lg transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isPending
                    ? isEn
                      ? "Sending…"
